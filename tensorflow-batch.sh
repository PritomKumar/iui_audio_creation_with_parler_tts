!/bin/bash
#SBATCH --job-name=Tensorflow-sample
#SBATCH --chdir=/[wrk-vakka|wrk-kappa]/users/$USER/
#SBATCH -o tensorflow-example-%J.txt
#SBATCH  -M <ukko|kale>
#SBATCH  -p <gpu>
...
# mkdir /home/pdas/pip-cache/
# paste this in windows address bar
# \\turso-fs.cs.helsinki.fi\home\pdas\whisper_project
